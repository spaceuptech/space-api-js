 ...
 * @external Monitor
 * @see {@link https://github.com/spaceuptech/space-api-node/wiki/Monitor}
 */
...
class Mongo {
   ...
   * @param {string} collection - The collection to monitor.
  ...
  monitor(collection) {
    return this.realTime.monitor('mongo', collection, '_id')
  }
