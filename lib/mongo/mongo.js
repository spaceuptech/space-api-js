...
class Mongo {
  ...
  beginBatch() {
    return new Batch(this.appId, this.url, this.options);
  }
  ...
  editProfile(id, email, name, pass) {
    ...
    let url = mongoURL(this.url, this.appId, 'auth', `edit_profile/${id}`);
  ...
  switch (condition.type) {
    case 'and':
      ...
      condition.clauses.forEach(clause => {
        generated = generateFind(clause)
        if (clause.type == 'cond') {
          if (d[clause.f1] == undefined) {
            d = Object.assign(d, generated)
          }
          else {
            d = Object.assign(d[clause.f1], generated[clause.f1])
          }
        }
        else {
          d = Object.assign(d, generated)
