...
const LiveQuerySubscription = require('./subscription')
...
class LiveQuery {
  ...
  addSubscription(id, onSnapshot, onError) {
    ...
    return () => {
      ...
      this.client.request('realtime-unsubscribe', { group: this.collection, dbType: this.db, id: id, options: this.opts })
